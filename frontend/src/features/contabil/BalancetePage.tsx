...
import { formatCompetencia, formatMoney } from '@/lib/format';
...
function SaldoRow({ saldo }: { saldo: SaldoContabil }) {
...
function Dinheiro({ cents, natureza }: { cents: number; natureza: 'D' | 'C' | null }) {
  return (
    <>
      {formatMoney(cents)}
